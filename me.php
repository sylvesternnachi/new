		...
		<div class="top-bar">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div class="col-lg-12">
					<div id="table-box">
						<div class="title-box">
						<p style="font-size: 18px;color:#fff">Monitor & Evaluation <i style="float:right"><img src="assets/img/settings-icon.svg" style="width:20px"></i></p>
					  ...
					  <tbody style="  font-family: 'Rubik', sans-serif; padding: 2%"> 
					   ...
					   <td>004</td>
					   	  <td>02/03/2018</td> 
					  		 ...
					  		 <td><a href="medetails.php"><button style="background: #45B6AF; border:none; border-radius: 40px; padding: 5% 12%; color:white">view</button></a></td> 
					   	</tr> 
