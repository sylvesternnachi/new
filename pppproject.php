		...
		<div class="top-bar">
			...
			<div class="col-md-4 hidden-sm col-xs-12">
				<div class="topbox all shadow">
					...
					<img src="assets/img/pppwhite.svg" style="width: 55px;">
					<br/>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div class="col-lg-12">
					<div id="table-box">
						<div class="title-box">
						<p style="font-size: 18px;color:#fff">PPP to Project <i style="float:right"><img src="assets/img/settings-icon.svg" style="width:20px"></i></p>
