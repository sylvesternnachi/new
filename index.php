	...
	<div id="content-box" class="right">
		...
		<div class="top-bar">
			...
			<div class="col-md-3 col-sm-4 col-xs-12">
				<div class="topbox">
					<div class="col-md-5  col-sm-6 col-xs-6">
					<img src="assets/img/new.svg" style="width: 50px;">
					<br/>
			...
			<div class="col-md-3 col-sm-4 col-xs-12">
				<div class="topbox">
					...
					<img src="assets/img/mask2.svg" style="width: 55px;">
					<br/>
			...
			<div class="col-md-3 col-sm-4 col-xs-12">
				<div class="topbox">
					<div class="col-md-4  col-sm-6 col-xs-6">
					<img src="assets/img/mask3.svg" style="width: 55px; ">
					<br/>
					<img src="assets/img/rec3.svg" style="width: 65px; ">
					</div>
				<div class="col-md-7  hidden-sm col-xs-6">
				...
				<div class="col-lg-12">
					<div id="table-box">
						<div class="title-box">
						<p style="font-size: 18px;color:#fff">Recent Activities <i style="float:right"><img src="assets/img/settings-icon.svg" style="width:20px"></i></p>
