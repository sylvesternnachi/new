			...
			<div id="details-box">
					...
					<div class="col-lg-5" style="padding-top: 3%">
						...
						<div class="stat-box" > 
							...
							<img src="assets/img/rejected.svg" style="width:18px; float:left"> 
							<p style="color:#FF1B1B" align="right">Rejected</p> </div>
				...
				<div class="col-lg-12">
					...
					<div style="padding: 2%">
						...
						<div class="col-md-4" style="padding: 0px; margin-bottom: 4%">
							<input type="text" class="form-box" name="" placeholder="Add Task">
						</div>
