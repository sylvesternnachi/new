		...
		<div class="top-bar">
			...
			<div class="col-md-3 hidden-sm col-xs-12">
				<div class="topbox fade ">
					...
					<img src="assets/img/259500.svg" style="width: 65px; ">
					</div>
			...
			<div class="col-md-3 col-sm-4 col-xs-12">
				<div class="topbox red shadow">
					<div class="col-md-4  col-sm-6 col-xs-6">
					<img src="assets/img/mask3white.svg" style="width: 45px; ">
					<br/>
				...
				<div class="col-lg-12">
					<div id="table-box">
						<div class="title-box">
						<p style="font-size: 18px;color:#fff">Rejected Proposal <i style="float:right"><img src="assets/img/settings-icon.svg" style="width:20px"></i></p>
					  ...
					  <tbody style="  font-family: 'Rubik', sans-serif; padding: 2%"> 
					  	<tr> 
					  		<td>001</td>
					  		 ...
					  		 <td>Business</td> 
					  		 <td>
					  		 	<a href="rejectedproposal-details.php">
					  	...
					  	<tr> 
					  		<td>002</td>
					  		 ...
					  		 <td>10000 Available of GPRA</td> 
					  		 <td>Business</td> 
					  		 <td><a href="rejectedproposal-details.php">
					   ...
					   <td>004</td>
					   	  <td>02/03/2018</td> 
					  		 ...
					  		 <td>10000 Available of GPRA</td> 
					  		  <td>Business</td> 
					  		 <td><a href="rejectedproposal-details.php"><button style="background: #45B6AF; border:none; border-radius: 40px; padding: 5% 12%; color:white">view</button></a></td> 
					   	</tr> 
